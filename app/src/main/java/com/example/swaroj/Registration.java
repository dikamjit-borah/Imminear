...
public class Registration extends AppCompatActivity {
    ...
    String name_string, email_string, address_string;
    String USER_ID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(Registration.this);
        // getLastLocation();

        name = findViewById(R.id.editText_name_reg);
        email = findViewById(R.id.editText_email_reg);
        address = findViewById(R.id.editText_address_reg);
        ...
        final DocumentReference documentReference2 = firestore.collection("LOCALS").document(USER_ID);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(name_string.isEmpty() || email_string.isEmpty() || address_string.isEmpty())
                {
...
//                    ref.setValue(name);
                    ...
                    locals.put("NAME_", name_string);
                    locals.put("EMAIL_", email_string);
                    locals.put("ADDRESS_", address_string);
                    locals.put("TYPE_", "LOCAL");
                   ...
                   /* documentReference2.set(migrants_coordinates).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    documentReference.set(locals).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful())
                            {
